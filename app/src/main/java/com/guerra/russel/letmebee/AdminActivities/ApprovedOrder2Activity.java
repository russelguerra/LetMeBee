...
public class ApprovedOrder2Activity extends AppCompatActivity {
    private static final String TAG = "ApprovedOrder2Activity";

    TextView tv_id, tv_date, tv_approvedDate, tv_name, tv_size, tv_quantity, tv_price, t3, tv_by;
    ...
    String id, dateOrdered, productName, productSize, productID, dateApproved, email, userName, userAddress, userPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approved_order2);
        ...
        tv_by.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(ApprovedOrder2Activity.this, ProfileActivity.class);
                profile.putExtra("EMAIL", email);
                profile.putExtra("NAME", userName);
                profile.putExtra("ADDRESS", userAddress)
    ...
    private void deliver() {
        Intent deliver = new Intent(ApprovedOrder2Activity.this, DeliverOrderActivity.class);
                            ...
                            db.document("Users/" + email)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            ...
                                            userName = currUser.getFirstname() + " " + currUser.getLastname();
                                            userAddress = currUser.getAddress();
                                            userPhone = currUser.getPhone();
                                        }
                                    });
                        }
                    });
