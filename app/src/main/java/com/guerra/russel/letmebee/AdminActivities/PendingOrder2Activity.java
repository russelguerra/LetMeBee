...
public class PendingOrder2Activity extends AppCompatActivity {
    private static final String TAG = "PendingOrder2Activity";

    TextView tv_id, tv_name, tv_quantity, tv_size, tv_price, tv_date, t3, tv_by;
    ...
    String id, dateOrdered, productName, productSize, productID, userName, userAddress, userPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_by.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(PendingOrder2Activity.this, ProfileActivity.class);
